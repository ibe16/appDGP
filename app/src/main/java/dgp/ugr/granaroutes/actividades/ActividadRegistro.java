...
public class ActividadRegistro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_actividad_registro);
        mAuth = FirebaseAuth.getInstance();

        botonRegistroInicio = findViewById(R.id.boton_registro_email);
        ...
        botonRegistroInicio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    startActivity(new Intent(getApplicationContext(),ActividadRegistro.class));
            }
        });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ActividadRegistro.this, "Authentication failed.",
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(getApplicationContext(),"E-mail o contraseña incorrecta",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
